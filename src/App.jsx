...
function App() {
  ...
  return (
    <>
      ...
      <Hero
        h1="Weirong's Portfolio"
        h2="Weaving Wonders with Web Dev"
      ...
      <div>
        ...
        <Highlight
          ...
          title="Recipe Site"
          description="This website showcases 4 unique dishes across Chinese and Japanese cuisines. Each dish is beautifully presented with detailed recipes and step-by-step instructions. Explore the flavors of Asia and learn how to recreate these delicious dishes in your own kitchen."
        ...
        <Highlight
          ...
          textColorPill="text-cyan-200"
          title="World Clock"
          description="The World Clock is a dynamic application that displays the current time in major cities across the world. It allows you to add and customize timezones, providing you with a convenient way to keep track of time differences and plan your activities accordingly."
      ...
      <div className="flex flex-col gap-1 items-center mt-[8rem] pb-12">
        <p className="text-sm">
